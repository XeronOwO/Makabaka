...
{
	internal class ForwardWebSocket : CommonWebSocket, IDisposable
	{
		#region 构造函数与参数
		...
		public ForwardWebSocket(ForwardWebSocketService service, ForwardWebSocketServiceConfig config) : base()
		{
			_config = config;
